...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7401282886:AAG94yMHtPReZLezklQiwD3c6TGQ3yDtT7g")
...
# Optional admin user IDs (space separated)
ADMINS = set(int(x) for x in os.environ.get("ADMINS", "").split() if x.strip())
